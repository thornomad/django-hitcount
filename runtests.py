...
if __name__ == '__main__':
    ...
    parser.add_argument('--django', help=
        'Use Django test runner (>=1.8). Additional arguments in the form of tests.test_filename'
        , action='store_true')
    parser.add_argument('--no-flake8', help='Disable flake8 testing',
        action='store_true')
    parser.add_argument('--flake8-only', help='Only perform flake8 testing',
        action='store_true')
